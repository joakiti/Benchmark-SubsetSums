...
from Implementations.FasterSubsetSum.RandomizedGivenClassicFunction import RandomizedGivenClassicFunction
...
class Test(TestCase):
    ...
    @classmethod
    def setUp(cls):
        cls.fasterSubset = RandomizedGivenClassicFunction(False, 0)
